...
<html lang="en">
    <head>
        ...
        <title>Login - Empowered Blockchain Hub</title>
    ...
    <body class="">
        ...
        <div class="layoutAuthentication container-fluid">
            <div class="row">
            <div class="col-md-6">
                <div class="layoutAuthentication_illustration">
                    <img src="./assets/illustrations/drawing.svg" class="img-fluid" alt="login-illustration"> 
                </div>
            </div>
